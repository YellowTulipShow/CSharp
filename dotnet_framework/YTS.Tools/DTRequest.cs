...
namespace YTS.Tools
{
	...
	public class DTRequest
	{
     ...
     /// <param name="strName">表单参数</param>
		...
		{
            return ConvertTool.ToInt(HttpContext.Current.Request.QueryString[strName], defValue);
		}
        ...
        {
            return ConvertTool.ToDecimal(HttpContext.Current.Request.QueryString[strName], defValue);
        }
		...
		{
            return ConvertTool.ToFloat(HttpContext.Current.Request.QueryString[strName], defValue);
		}
