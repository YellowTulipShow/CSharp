...
namespace YTS.Model.Table
{
    ...
    public class WhereModel : AbsBasicDataModel
    {
        ...
        public static bool CheckIsCanUse(WhereModel wheres) {
            return AbsBasicDataModel.IsCanUse(wheres, ErrorMethod);
        }
        /// <summary>
        /// 检查是否可以使用 (多个)
        /// </summary>
    ...
    public class FieldValueModel : AbsBasicDataModel
    {
        ...
        public static bool CheckIsCanUse(FieldValueModel fielvals) {
            bool result = AbsBasicDataModel.IsCanUse(fielvals, m => CheckData.IsStringNull(m.Name));
            return result;
        }
        /// <summary>
        /// 检查是否可以使用 (多个)
    ...
    public class FieldOrderModel : AbsBasicDataModel
    {
        ...
        public static bool CheckIsCanUse(FieldOrderModel fielOrders) {
            return AbsBasicDataModel.IsCanUse(fielOrders, m => CheckData.IsStringNull(m.Name));
        }
        /// <summary>
        /// 检查是否可以使用 (多个)
        /// </summary>
