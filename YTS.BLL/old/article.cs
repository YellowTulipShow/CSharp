...
namespace YTS.BLL
{
    ...
    public partial class article
    {
        ...
        public bool Delete(int channel_id, int article_id)
        {
            ...
            {
                FileHelp.DeleteContentPic(content, sysConfig.webpath + sysConfig.filepath); //删除内容图片
            }
            return result;
        }
        ...
        public Model.article[] GetModelList(DataSet ds) {
            ...
            foreach (DataRow dr in ds.Tables[0].Rows) {
                list.Add(this.dal.DataRowToModel(dr));
            }
            return list.ToArray();
        }
        #endregion
