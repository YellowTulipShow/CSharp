...
namespace CSharp.LibrayFunction
{
    public class Utils
    {
        ...
        public static string GetVersion() {
            return LFKeys.ASSEMBLY_VERSION;
        }
        #endregion
        ...
        public static string GetOrderNumber() {
            ...
            return num + Number(8, true).ToString();
        }
        ...
        /// <returns></returns>
        public static bool Str_IsEmpty(string valueString) {
            return valueString != String.Empty && valueString != "" && valueString != null;
        }
        #endregion
