var Zepto = function () {
    ...
    function p(t) {
        var e, n;
        return k[t] || (e = _.createElement(t), _.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), k[t] = n), k[t]
    }
    ...
    function m(t, e, n) {
        for ($ in e) n && (o(e[$]) || K(e[$])) ? (o(e[$]) && !o(t[$]) && (t[$] = {}), K(e[$]) && !K(t[$]) && (t[$] = []), m(t[$], e[$], n)) : e[$] !== A && (t[$] = e[$])
    }
    ...
    return J.matches = function (t, e) {
        ...
        var i, r, a;
        return D.test(t) && (i = E(_.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(R, "<$1></$2>")), e === A && (e = Z.test(t) && RegExp.$1), e in B || (e = "*"), a = B[e], a.innerHTML = "" + t, i = E.each(P.call(a.childNodes), function () {
            a.removeChild(this)
        ...
        if (!t) return J.Z();
        if ("string" == typeof t)
            if (t = t.trim(), "<" == t[0] && Z.test(t)) i = J.fragment(t, RegExp.$1, n), t = null;
            else {
                if (n !== A) return E(n).find(t);
                i = J.qsa(_, t)
            } else {
            ...
            else if (Z.test(t)) i = J.fragment(t.trim(), RegExp.$1, n), t = null;
            else {
                if (n !== A) return E(n).find(t);
                i = J.qsa(_, t)
            }
        ...
        ready: function (t) {
            return H.test(_.readyState) && _.body ? t(E) : _.addEventListener("DOMContentLoaded", function () {
                t(E)
            }, !1), this
        },
        get: function (t) {
            return t === A ? P.call(this) : this[t >= 0 ? t : t + this.length]
        },
        toArray: function () {
            return this.get()
        },
        ...
        not: function (t) {
            var n = [];
            if (e(t) && t.call !== A) this.each(function (e) {
        ...
        siblings: function (t) {
            return g(this.map(function (t, e) {
                return N.call(h(e.parentNode), function (t) {
                    return t !== e
                })
            }), t)
        },
        ...
        css: function (e, n) {
            ...
            if ("string" == t(e)) n || 0 === n ? a = u(e) + ":" + f(e, n) : this.each(function () {
                ...
                for ($ in e) e[$] || 0 === e[$] ? a += u($) + ":" + f($, e[$]) + ";" : this.each(function () {
        ...
        offsetParent: function () {
            return this.map(function () {
                for (var t = this.offsetParent || _.body; t && !z.test(t.nodeName) && "static" == E(t).css("position") ;) t = t.offsetParent;
                return t
            })
        }
        ...
        E.fn[t] = function (r) {
            var o, a = this[0];
            return r === A ? n(a) ? a["inner" + e] : i(a) ? a.documentElement["scroll" + e] : (o = this.offset()) && o[t] : this.each(function (e) {
        ...
        E.fn[e] = function () {
            ...
            return o.length < 1 ? this : this.each(function (t, e) {
                ...
                var s = E.contains(_.documentElement, r);
    ...
    }), J.Z.prototype = d.prototype = E.fn, J.uniq = j, J.deserializeValue = b, E.zepto = J, E
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
	function (t) {
	    ...
	    function l(t) {
	        ...
	        for (e in t) $.test(e) || t[e] === f || (n[e] = t[e]);
	        return u(n, t)
	    }
	    var f, p = 1,
	    ...
	    t.fn.delegate = function (t, e, n) {
	        ...
	        return e && !m(e) ? (t.each(e, function (t, e) {
	            p.on(t, n, i, e, o)
	        }), p) : (m(n) || d(r) || r === !1 || (r = i, i = n, n = f), (r === f || i === !1) && (r = i, i = f), r === !1 && (r = A), p.each(function (f, p) {
	            o && (a = function (t) {
	...
	function (t) {
	    ...
	    function l(t) {
	        return t && (t = t.split(";", 2)[0]), t && (t == $ ? "html" : t == A ? "json" : b.test(t) ? "script" : x.test(t) && "xml") || "text"
	    }
	    ...
	    T.href = window.location.href, t.active = 0, t.ajaxJSONP = function (e, n) {
	        ...
	        return n && n.promise(h), t(l).on("load error", function (o, c) {
	            clearTimeout(r), t(l).off().remove(), "error" != o.type && i ? a(i[0], h, e, n) : s(null, c || "error", h, e, n), window[u] = f, i && t.isFunction(f) && f(i[0]), f = i = void 0
	        ...
	        i(c), c.crossDomain || (n = y.createElement("a"), n.href = c.url, n.href = n.href, c.crossDomain = T.protocol + "//" + T.host != n.protocol + "//" + n.host), c.url || (c.url = window.location.toString()), (r = c.url.indexOf("#")) > -1 && (c.url = c.url.slice(0, r)), p(c);
	        var d = c.dataType,
				v = /\?.+=\?/.test(c.url);
	        if (v && (d = "jsonp"), c.cache !== !1 && (e && e.cache === !0 || "script" != d && "jsonp" != d) || (c.url = f(c.url, "_=" + Date.now())), "jsonp" == d) return v || (c.url = f(c.url, c.jsonp ? c.jsonp + "=?" : c.jsonp === !1 ? "" : "callback=?")), t.ajaxJSONP(c, h);
	        var w, b = c.accepts[d],
				x = {},
				A = function (t, e) {
				    x[t.toLowerCase()] = [t, e]
				},
				$ = /^([\w-]+:)\/\//.test(c.url) ? RegExp.$1 : window.location.protocol,
				S = c.xhr(),
				j = S.setRequestHeader;
	        if (h && h.promise(S), c.crossDomain || A("X-Requested-With", "XMLHttpRequest"), A("Accept", b || "*/*"), (b = c.mimeType || b) && (b.indexOf(",") > -1 && (b = b.split(",", 2)[0]), S.overrideMimeType && S.overrideMimeType(b)), (c.contentType || c.contentType !== !1 && c.data && "GET" != c.type.toUpperCase()) && A("Content-Type", c.contentType || "application/x-www-form-urlencoded;charset=UTF-8"), c.headers)
	            for (g in c.headers) A(g, c.headers[g]);
	        if (S.setRequestHeader = A, S.onreadystatechange = function () {
					if (4 == S.readyState) {
						S.onreadystatechange = u, clearTimeout(w);
						var e, n = !1;
						if (S.status >= 200 && S.status < 300 || 304 == S.status || 0 == S.status && "file:" == $) {
							d = d || l(c.mimeType || S.getResponseHeader("content-type")), e = S.responseText;
							try {
								"script" == d ? (1, eval)(e) : "xml" == d ? e = S.responseXML : "json" == d && (e = E.test(e) ? null : t.parseJSON(e))
	        } catch (i) {
								n = i
	        }
							n ? s(n, "parsererror", S, c, h) : a(e, S, c, h)
	        } else s(S.statusText || null, S.status ? "error" : "abort", S, c, h)
	        }
	        }, o(S, c) === !1) return S.abort(), s(null, "abort", S, c, h), S;
	        if (c.xhrFields)
	            for (g in c.xhrFields) S[g] = c.xhrFields[g];
	        var C = "async" in c ? c.async : !0;
	        S.open(c.type, c.url, C, c.username, c.password);
	        for (g in x) j.apply(S, x[g]);
	        return c.timeout > 0 && (w = setTimeout(function () {
	            S.onreadystatechange = u, S.abort(), s(null, "timeout", S, c, h)
	...
	function (t) {
	    function e(t, e) {
	        var n = this.os = {},
				...
				h = t.match(/PlayBook/),
				d = t.match(/Chrome\/([\d.]+)/) || t.match(/CriOS\/([\d.]+)/),
				m = t.match(/MSIE\s([\d.]+)/) || t.match(/Trident\/[\d](?=[^\?]+).*rv:([0-9.].)/),
				g = !d && t.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/),
				v = g || t.match(/Version\/([\d.]+)([^S](Safari)|[^M]*(Mobile)[^S]*(Safari))/);
	        (i.webkit = !!r) && (i.version = r[1]), o && (n.android = !0, n.version = o[2]), u && !c && (n.ios = n.iphone = !0, n.version = u[2].replace(/_/g, ".")), s && (n.ios = n.ipad = !0, n.version = s[2].replace(/_/g, ".")), c && (n.ios = n.ipod = !0, n.version = c[3] ? c[3].replace(/_/g, ".") : null), p && (n.wp = !0, n.version = p[1]), l && (n.webos = !0, n.version = l[2]), h && (i.playbook = !0), d && (i.chrome = !0, i.version = d[1]), m && (i.ie = !0, i.version = m[1]), v && (a || n.ios || f) && (i.safari = !0, n.ios || (i.version = v[1])), g && (i.webview = !0)
	    }
	    e.call(t, navigator.userAgent, navigator.platform), t.__detect = e, t.extend(t, {
	        isApp: function () {
	            var t = navigator.userAgent.match(/SNEBUY-APP;?/i);
	            return t ? !0 : !1
	        }()
	    })
	}(Zepto),
	function (t, e) {
	    ...
	    t.each(m, function (t, n) {
	    ...
	    }), o = d + "transform", y[a = d + "transition-property"] = y[s = d + "transition-duration"] = y[u = d + "transition-delay"] = y[c = d + "transition-timing-function"] = y[l = d + "animation-name"] = y[f = d + "animation-duration"] = y[h = d + "animation-delay"] = y[p = d + "animation-timing-function"] = "", t.fx = {
	        ...
	        var w, b, x, A = {},
				...
				S = !1;
	        if (r === e && (r = t.fx.speeds._default / 1e3), g === e && (g = 0), t.fx.off && (r = 0), "string" == typeof i) A[l] = i, A[f] = r + "s", A[h] = g + "s", A[p] = d || "linear", T = t.fx.animationEnd;
	        else {
	            b = [];
	            for (w in i) v.test(w) ? $ += w + "(" + i[w] + ") " : (A[w] = i[w], b.push(n(w)));
	            $ && (A[o] = $, b.push(o)), r > 0 && "object" == typeof i && (A[a] = b.join(", "), A[s] = r + "s", A[u] = g + "s", A[c] = d || "linear")
	        }
	        return x = function (e) {
	        ...
	        }, r > 0 && (this.bind(T, x), setTimeout(function () {
	            S || x.call(E)
	        }, 1e3 * (r + g) + 25)), this.size() && this.get(0).clientLeft, this.css(A), 0 >= r && setTimeout(function () {
	            E.each(function () {
	                x.call(this)
	            })
	        }, 0), this
	...
	function (t) {
	    ...
	    t.when = function (i) {
	        ...
	        if (c > 1)
	            for (r = new Array(c), o = new Array(c), a = new Array(c) ; c > u; ++u) s[u] && t.isFunction(s[u].promise) ? s[u].promise().done(p(u, a, s)).fail(f.reject).progress(p(u, o, r)) : --l;
	    ...
	    i.qsa = function (e, o) {
	        return n(o, function (n, a, s) {
	            try {
	                ...
	                throw console.error("error performing selector: %o", o), p
	            } finally {
	                l && l.removeClass(u)
	            }
	...
	function (t) {
	    ...
	    t(document).ready(function () {
	        ...
	        "MSGesture" in window && (f = new MSGesture, f.target = document.body), t(document).bind("MSGestureEnd", function (t) {
	            ...
	            (!(v = a(t, "move")) || o(t)) && (g = v ? t : t.touches[0], i(), p.x2 = g.pageX, p.y2 = g.pageY, y += Math.abs(p.x1 - p.x2), w += Math.abs(p.y1 - p.y2))
	        }).on("touchend MSPointerUp pointerup", function (n) {
	            (!(v = a(n, "up")) || o(n)) && (i(), p.x2 && Math.abs(p.x1 - p.x2) > 30 || p.y2 && Math.abs(p.y1 - p.y2) > 30 ? u = setTimeout(function () {
	                p.el.trigger("swipe"), p.el.trigger("swipe" + e(p.x1, p.x2, p.y1, p.y2)), p = {}
	            }, 0) : "last" in p && (30 > y && 30 > w ? c = setTimeout(function () {
	                var e = t.Event("tap");
	                e.cancelTouch = r, p.el.trigger(e), p.isDoubleTap ? (p.el && p.el.trigger("doubleTap"), p = {}) : s = setTimeout(function () {
	...
	function (t) {
	...
	}(Zepto), "function" == typeof Zepto && ! function (t) {
	    ...
	    var a = /\+/g,
			s = t.cookie = function (r, a, c) {
			    if (void 0 !== a && !t.isFunction(a)) {
			        if (c = t.extend({}, s.defaults, c), "number" == typeof c.expires) {
			            var u = c.expires,
			    ...
			    for (var f = r ? void 0 : {}, p = document.cookie ? document.cookie.split("; ") : [], h = 0, d = p.length; d > h; h++) {
			        var m = p[h].split("="),
						g = n(m.shift()),
						v = m.join("=");
			        if (r && r === g) {
	    ...
	    function t(t) {
	        return t.replace(w, "").replace(b, ",").replace(x, "").replace(A, "").replace($, "").split(E)
	    }
	    ...
	    function n(n, i) {
	        ...
	        function o(e) {
	            ...
	            return a && (e = "$line=" + n + ";" + e), v(t(e), function (t) {
	                if (t && !m[t]) {
	                    var e;
	                    e = "print" === t ? b : "include" === t ? x : h[t] ? "$utils." + t : d[t] ? "$helpers." + t : "$data." + t, A += t + "=" + e + ",", m[t] = !0
	                }
	            }), e + "\n"
	        }
	        var a = i.debug,
	        ...
	        v(n.split(s), function (t) {
	            t = t.split(c);
	            var e = t[0],
					n = t[1];
	            1 === t.length ? $ += r(e) : ($ += o(e), n && ($ += r(n)))
	        });
	        var T = A + $ + E;
	        a && (T = "try{" + T + "}catch(e){throw {filename:$filename,name:'Render Error',message:e.message,line:$line,source:" + e(n) + ".split(/\\n/)[$line-1].replace(/^\\s+/,'')};}");
	        try {
	            var S = new Function("$data", "$filename", T);
	            return S.prototype = h, S
	        } catch (j) {
	            throw j.temp = "function anonymous($data,$filename) {" + T + "}", j
	        }
	    }
	    var i = function (t, e) {
	    ...
	    var m = function (t) {
			...
			g = i.compile = function (t, e) {
			    ...
			    return i.prototype = c.prototype, i.toString = function () {
			        return c.toString()
			    }, s && e.cache && (o[s] = i), i
			},
			v = h.$each,
	        ...
	        switch (r) {
	            ...
	            default:
	                if (/^\s*\|\s*[\w\$]/.test(o)) {
	                    ...
	                    for (var p = 0, h = t.split("|"), d = h.length, m = h[p++]; d > p; p++) m = T(m, h[p]);
	                    t = (f ? "=" : "=#") + m
	                } else t = i.helpers[r] ? "=#" + r + "(" + n.join(",") + ");" : "=" + t
	        }
	        return t
			...
			i = function () {
			    function i(n, i, o) {
			        if (n.src) {
			            ...
			            for (var a = 0; a < n.src.length; a++) n.src[a].constructor !== Array && (n.src[a] = [n.src[a]]), t.push({
			                src: n.src[a],
			                callback: n.src.length != a + 1 || o ? void 0 : i,
			                complete: 0
			            })
			        }
			        e || r()
			    ...
			    function r() {
			        ...
			        $.each(document.scripts, function () {
			            this.src && i.push(this.src.split("?")[0])
			        });
			        var r, c, u = t[n];
			        if (u) {
			            e = !0, n++, a = a || s.getElementsByTagName("head")[0];
			            for (var l = 0; l < u.src.length; l++) c = u.src[l], i.indexOf(c.split("?")[0]) < 0 ? (r = s.createElement("script"), r.src = c, r.type = "text/javascript", r.onload = r.onerror = function () {
			                o(u)
			            }, a.appendChild(r)) : o(u)
			        }
			    }
			    ...
			    function o(t) {
			        t.complete++, "function" == typeof t.callback && t.callback(), e = !1, t.complete == t.src.length && r()
			    }
			    var a, s = document;
			    return {
			        init: function (t, e, n) {
	...
	function (t) {
	    var e = !1,
			n = new Image;
	    n.src = "data:image/webp;base64,UklGRiwAAABXRUJQVlA4ICAAAAAUAgCdASoBAAEAL/3+/3+CAB/AAAFzrNsAAP5QAAAAAA==", n.onerror = n.onload = function () {
	        1 === n.width && 1 === n.height && (e = !0, t.isWebp = e)
	    }
	}(Zepto),function (t, e) {
	    ...
	    function t(t, e) {
	        function n(t, e) {
	            ...
	            }, t.src = t.getAttribute("data-src"), $(e).removeClass("opa0").addClass("opa1"), $.isWebp && (t.src += ""), t.setAttribute("data-src", "done")
	        }
	        var i = null,
				r = e;
	        r = "undefined" != typeof r && "function" != typeof r ? "touchmove touchend scroll" : "scroll", $(t).find("img").each(function () {
	            !$(t).hasClass("lazyimg") && $(t).addClass("lazyimg");
	            var e = $(this)[0];
	            null != e.getAttribute("data-src") && $(this).offset().top < window.innerHeight && "done" != e.getAttribute("data-src") && n(e, this)
	        }), $(window).on("lazyload " + r, function () {
	            i = setTimeout(function () {
	                $(t).find("img").each(function () {
	                    ...
	                    if (null != e.getAttribute("data-src")) {
	                        ...
	                        return window.pageYOffset > r + o || window.pageYOffset < r - o && "done" != e.getAttribute("data-src") ? void clearTimeout(i) : void (window.pageYOffset > r - o && "done" != e.getAttribute("data-src") && n(e, this))
	                    }
	                }), "function" == typeof e && $(t).each(function () {
	                    var n = $(this)[0],
							r = $(this).offset().top,
							o = window.innerHeight || window.screen.height;
	                    return window.pageYOffset > r + o || window.pageYOffset < r - o && "done" != n.getAttribute("data-loaded") ? void clearTimeout(i) : void (window.pageYOffset > r - o - 30 && "done" != n.getAttribute("data-loaded") && e($(t)))
	                })
	            }, 20)
	        }), setTimeout(function () {
	    ...
	    return (window.Zepto || window.jQuery) && ! function (e) {
	        e.fn.lazyload = function (n) {
	            return this.each(function () {
	                t(e(this), n)
	            })
	        }
	    }(window.Zepto || window.jQuery), t
	});