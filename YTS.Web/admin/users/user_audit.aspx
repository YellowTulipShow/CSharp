<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_audit.aspx.cs" Inherits="YTS.Web.admin.users.user_audit" ValidateRequest="false" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new YTS.BLL.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%></td>
