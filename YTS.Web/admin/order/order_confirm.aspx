<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_confirm.aspx.cs" Inherits="YTS.Web.admin.order.order_confirm" ValidateRequest="false" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new YTS.BLL.site_payment().GetTitle(Convert.ToInt32(Eval("payment_id")))%></td>
    <td><%#new YTS.BLL.express().GetTitle(Convert.ToInt32(Eval("express_id")))%></td>
