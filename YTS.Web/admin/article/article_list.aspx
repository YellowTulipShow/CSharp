<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_list.aspx.cs" Inherits="YTS.Web.admin.article.article_list" ValidateRequest="false" %>
...
<style type="text/css">
    ...
    .article_status_bg_1 {
        ...
        .article_status_bg_1:hover {
            background-color: #fe7171 !important;
        }

    .article_status_bg_2 {
        background-color: #adc7fc !important;
    }
        .article_status_bg_2:hover {
            background-color: #719ffe !important;
        }
    .IsCmForumInputPeople_True {
    ...
    <div class="box-wrap">
      ...
      <div class="l-list">
        <ul class="icon-list">
          ...
          <li class="IsCmForumInputPeople_<%=this.IsCmForumInputPeople.ToString()%>"><asp:LinkButton ID="btnAudit" runat="server" OnClientClick="return ExePostBack('btnAudit','审核后前台将显示该信息，确定继续吗？');" onclick="btnAudit_Click"><i class="iconfont icon-survey"></i><span>审核</span></asp:LinkButton></li>
...
<div class="table-container">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
    <tr>
      ...
      <th align="left" width="12%">所属类别(组别)</th>
  ...
  <ItemTemplate>
    <tr class="article_status_bg_<%#Eval("status")%>">
      <td align="center">
  ...
  <ItemTemplate>
      <li>
        <div class="article_status_bg_<%#Eval("status")%> details<%#Eval("img_url").ToString() != "" ? "" : " nopic"%>">
          <div class="check">
...
<div class="pagelist">
    <div class="l-btns">
        <span><i class="article_status_bg_1">&nbsp;&nbsp;&nbsp;&nbsp;</i>&nbsp;状态: 待审核</span>
        <span><i class="article_status_bg_2">&nbsp;&nbsp;&nbsp;&nbsp;</i>&nbsp;状态: 停用</span>
    </div>
</div>
<!--/内容底部-->
