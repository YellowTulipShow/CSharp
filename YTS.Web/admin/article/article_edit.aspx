<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_edit.aspx.cs" Inherits="YTS.Web.admin.article.article_edit" ValidateRequest="false" %>
  ...
  <div class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        ...
        <li class="IsCmForumInputPeople_<%=IsCmForumInputPeople.ToString()%>"><a href="javascript:;">SEO选项</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="tab-content">
  ...
  <dl class="IsCmForumInputPeople_<%=IsCmForumInputPeople.ToString()%>">
    <dt>推荐类型</dt>
    <dd>
...
<div class="tab-content" style="display:none">
  ...
  <dl ID="div_source" runat="server" visible="false" class="IsCmForumInputPeople_<%=IsCmForumInputPeople.ToString()%>">
  ...
  <dl ID="div_author" runat="server" visible="false" class="IsCmForumInputPeople_<%=IsCmForumInputPeople.ToString()%>">
...
<div class="tab-content IsCmForumInputPeople_<%=IsCmForumInputPeople.ToString()%>" style="display:none">
  <dl>
    <dt>SEO标题</dt>
    <dd>
