...
namespace YTS.Web.admin.article
{
    public partial class article_edit : Web.UI.ManagePage
    {
        ...
        private void ShowInfo(int _channel_id, int _id)
        {
            ...
            //}
            cblItem.Items[0].Selected = model.is_msg == 1;
            cblItem.Items[1].Selected = model.is_top == 1;
            cblItem.Items[2].Selected = model.is_red == 1;
            cblItem.Items[3].Selected = model.is_hot == 1;
            cblItem.Items[4].Selected = model.is_slide == 1;
            //扩展字段赋值
        ...
        private bool DoAdd()
        {
            ...
            model.is_red = cblItem.Items[2].Selected ? 1 : 0;
            model.is_hot = cblItem.Items[3].Selected ? 1 : 0;
            model.is_slide = cblItem.Items[4].Selected ? 1 : 0;
