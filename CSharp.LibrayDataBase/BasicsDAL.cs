...
using CSharp.LibrayDataBase.BasicsUtility;
...
namespace CSharp.LibrayDataBase
{
    public class BasicsDAL<M> : ITableBasicFunction<M> where M : AbsTableModel
    {
        ...
        /// 数据表前缀
        /// </summary>
        private const string _databaseprefix = "dt_";
        /// <summary>
        /// 规范 属性 数据模型
        /// </summary>
        private M normativeAttributeModel;
        ...
        public string TableName {
            get { return databaseprefix + DataModel.GetType().Name; }
        }
        /// <summary>
        /// 获得数据模型
        /// </summary>
        ...
        public BasicsDAL(M model) {
            this.normativeAttributeModel = model;
        }
        #endregion
        ...
        public virtual bool Delete(int id) {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from " + TableName + " where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        /// <returns></returns>
        public virtual bool Transaction(string[] strlist) {
            if (strlist.Length <= 0) {
                return false;
            }
        ...
        public virtual M GetModel(int id) {
            ...
            StringBuilder str1 = new StringBuilder();
            //利用反射获得属性的所有公共属性
            PropertyInfo[] pros = DataModel.GetType().GetProperties();
